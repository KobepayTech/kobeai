...
import voiceEnrollmentRouter from "./voice-enrollment";
import classroomQueueRouter from "./classroom-queue";
import studentMeRouter from "./student-me";
import studentLearnRouter from "./student-learn";
...
router.use(voiceEnrollmentRouter);
router.use(classroomQueueRouter);
router.use(studentMeRouter);
router.use(studentLearnRouter);
