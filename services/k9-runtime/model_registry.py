...
MODEL_SPECS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec(
        ...
        "transformers_vlm",
        optional=True,
        notes="Optional Qwen multimodal upgrade; not installed by the K9 except-Qwen downloader.",
    ),
    ModelSpec("youtu-llm-2b", "agent", r"tencent/agents/youtu-llm-2b", "transformers_text", True),
    ModelSpec(
        "hunyuan-4b-instruct",
        "reasoning",
        r"tencent/agents/hunyuan-4b-instruct",
        "transformers_text",
        notes="Tencent text/reasoning fallback downloaded by the K9 model installer.",
    ),
...
CAPABILITY_ROUTES: dict[str, tuple[str, ...]] = {
    ...
    "reasoning": ("deepseek-gguf", "hunyuan-4b-instruct", "qwen-gguf", "qwen3-vl-8b"),
    "agent": ("youtu-llm-2b", "qwen-gguf"),
    "vision": ("youtu-vl-4b", "qwen3-vl-8b"),
    "multimodal_reasoning": ("youtu-vl-4b", "qwen3-vl-8b"),
